...
public class GraphicOverlay extends View {
    private static final String TAG = "ProjectAlex_GraphicOverlay";
    ...
    /**
     * To Get Number of Faces Detected
     */
    public int getSize() {
        Log.d(TAG, "getSize");
        synchronized (mLock) {
    ...
    public Set<Graphic>  getFaceGraphics() {
        Log.d(TAG, "getFaceGraphics");
        synchronized (mLock) {
            return mGraphics;
        }
    }
